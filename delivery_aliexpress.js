(function() {
   ...
   webviewWrapper.processLoginPage = function(showButtons) {
    ...
    webviewWrapper.getOrders = function() {
        var e=document.querySelector(".order-list");if(null==e)return null;var t=document.querySelector("div[placeholder]");if(null==t)return null;if(!t.classList.contains("amp-hidden"))return"loading";if(null!=e.getElementsByClassName("ms-ept-page")[0])return"empty";for(var r=[],l=[],a=e.getElementsByClassName("order-item"),i=0;i<a.length;i++){var n=a[i],s=n.getElementsByClassName("order-item-id")[0];if(null!=s){var m=s.textContent,d=m.split(":");if(2==d.length){var o=d[1].trim(),u=n.getElementsByClassName("order-action")[0];if(null!=u){var g=u.getElementsByTagName("a")[0];if(null!=g){var c=g.getAttribute("href");if(c.includes("logistics")){var f=n.getElementsByTagName("img")[0];if(null!=f||null!=(f=n.getElementsByTagName("amp-img")[0])){var p=f.getAttribute("src"),v=n.getElementsByClassName("order-product-title")[0];if(null!=v){var y={orderId:o,trackUrl:c,additionalTrackUrl:"https://track.aliexpress.com/logisticsdetail.htm?tradeId="+o,imageUrl:p,title:v.textContent};r.push(y)}}}}}}else l.push("fail to parse orderId: "+m)}else l.push("fail to find order-item-id")}var h={data:r,errors:l};JSON.stringify(h);
    }
